...
public struct ClusterItem: Hashable {
    public let id: Int
    public let coordinate: Coordinate
    public let tag: NSObject

    public init(id: Int, coordinate: Coordinate, tag: NSObject) {
        self.id = id
...
public protocol ClustererProtocol: AnyObject {
